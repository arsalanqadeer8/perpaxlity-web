...
if start_idx != -1 and end_idx != -1:
    new_landing = f'<!-- LANDING -->\n<div id="landing-page" class="text-on-surface font-body-lg overflow-x-hidden">\n{body_contents}\n</div>\n\n'
    index_html = index_html[:start_idx] + new_landing + index_html[end_idx:]
